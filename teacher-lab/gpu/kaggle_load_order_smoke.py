...
for token in ['data_factory_v2.py','CALIBRATION PASS','summarize_factory_review.py','review-priority.jsonl','package_factory_artifact.py']:
...
print('Kaggle teacher load order, pinned revisions, Data Factory pilot, priority review, triage, and portable handoff contracts passed.')
