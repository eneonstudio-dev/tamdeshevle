...
const PRODUCTS = [
  { id: "milk", emoji: "🥛", name: "Молоко 2,5%", pack: "1 л", prices: { pyat: 104, magnit: 95, perek: 109, lenta: 99, dixy: 101, lavka: 129, vprok: 112 } },
  { id: "bread", emoji: "🍞", name: "Хлеб дарницкий", pack: "650 г", prices: { pyat: 69, magnit: 59, perek: 75, lenta: 64, dixy: 62, lavka: 89, vprok: 72 } },
  { id: "chicken", emoji: "🍗", name: "Филе куриное", pack: "1 кг", prices: { pyat: 379, magnit: 349, perek: 399, lenta: 359, dixy: 369, lavka: 449, vprok: 389 } },
  { id: "banana", emoji: "🍌", name: "Бананы", pack: "1 кг", prices: { pyat: 135, magnit: 119, perek: 145, lenta: 125, dixy: 129, lavka: 169, vprok: 139 } },
  { id: "oil", emoji: "🫙", name: "Масло подсолнечное", pack: "1 л", prices: { pyat: 155, magnit: 139, perek: 165, lenta: 145, dixy: 149, lavka: 189, vprok: 159 } },
  { id: "eggs", emoji: "🥚", name: "Яйца С1", pack: "10 шт", prices: { pyat: 115, magnit: 99, perek: 125, lenta: 105, dixy: 109, lavka: 139, vprok: 119 } },
  { id: "buck", emoji: "🌾", name: "Гречка", pack: "800 г", prices: { pyat: 95, magnit: 79, perek: 105, lenta: 85, dixy: 89, lavka: 119, vprok: 99 } },
  { id: "sour", emoji: "🥛", name: "Сметана 20%", pack: "300 г", prices: { pyat: 105, magnit: 89, perek: 115, lenta: 95, dixy: 99, lavka: 129, vprok: 109 } },
  { id: "sugar", emoji: "🧊", name: "Сахар", pack: "1 кг", prices: { pyat: 82, magnit: 72, perek: 89, lenta: 76, dixy: 79, lavka: 99, vprok: 84 } },
  { id: "pasta", emoji: "🍝", name: "Макароны", pack: "450 г", prices: { pyat: 75, magnit: 62, perek: 82, lenta: 68, dixy: 71, lavka: 95, vprok: 78 } }
];
...
function applyCityPrices() {
  const book = PRICE_BOOK && PRICE_BOOK.flat && PRICE_BOOK.flat[state.city];
  if (!book) return;
  PRODUCTS.forEach(p => {
    if (book[p.id]) p.prices = Object.assign({}, p.prices, book[p.id]);
  });
...
async function loadPrices() {
  try {
    const res = await fetch("prices.json?v=20260909");
...
const sumIn = (id) => cartEntries().reduce((a, p) => a + (p.prices[id] || 0) * state.cart[p.id], 0);
