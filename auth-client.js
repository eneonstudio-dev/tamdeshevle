(function(){
  ...
  window.TDAuth={init,configured,user,signInWithEmail,signOut,syncLocalToCloud,hydrateLocalFromCloud,cloudSummary,submitReceiptEvidence,receiptQueue,cloudStatus:()=>({...cloudState}),open:modal};
