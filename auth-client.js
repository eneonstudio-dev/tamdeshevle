(function(){
  ...
  window.TDAuth={init,configured,user,signInWithEmail,signOut,syncLocalToCloud,hydrateLocalFromCloud,cloudSummary,submitReceiptEvidence,receiptQueue,isReceiptReviewer,receiptReviewQueue,receiptProofUrl,reviewReceipt,cloudStatus:()=>({...cloudState}),open:modal};
