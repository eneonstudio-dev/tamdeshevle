(function(){
  ...
  function quality(productId,storeId,channel="shelf"){const meta=window.TDPriceMeta?.get?.(productId,storeId,channel);if(meta?.scope_verified)return"LIVE";if(meta)return"RECENT";return"ESTIMATED";}
  ...
  window.TDStoreAdapters={adapter,catalog,qualities:["LIVE","RECENT","ESTIMATED","UNKNOWN"]};
})();
