...
for(const needle of ['Продолжить в магазинах','TDContinueInStoresV1','data-store-id','Цена, наличие и фактическое добавление подтверждаются самим магазином'])if(!flow.includes(needle))throw new Error('missing flow contract: '+needle);
...
console.log('continue-in-stores smoke: ok');