...
Fresh-read baseline for the current pass: `main` at `8c4de55c5b1838aff6334a0c68ddfe4763a0139c` on 2026-09-14.
...
While the golden shopping core has an active P1 fix in PR #370, further purely cosmetic work should stay behind that critical path. Safe design work should focus on truth/reliability defects that can materially mislead or block the current loop without changing shopping-kernel semantics.
