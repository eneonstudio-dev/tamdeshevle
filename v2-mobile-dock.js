(() => {
  ...
  function createDock(){
    ...
    nav.innerHTML=`<button type="button" data-screen="home"><i>⌂</i><span>Главная</span></button><button type="button" data-screen="catalog"><i>⌕</i><span>Поиск</span></button><button type="button" data-screen="cart"><i>☷</i><span>Список</span></button><button type="button" data-screen="stores"><i>⌖</i><span>Карта</span></button><button type="button" data-screen="profile" class="td-profile-btn"><i>○</i><span>Профиль</span></button>`;
