(()=>{
  ...
  // for optional remote account/cloud/receipt flows is reviewed. These are release
  // controls, not user preferences: every remote path must fail closed when false.
