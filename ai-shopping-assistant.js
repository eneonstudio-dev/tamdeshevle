(function(){
  ...
  async function ensureMemory(){if(!window.TDBaiMemory){memoryLoad=memoryLoad||import("./bai-memory.js?v=20260911-memory-v1").catch(e=>{console.warn("[Bai Memory] load failed",e);return null});await memoryLoad}return window.TDBaiMemory||null}
