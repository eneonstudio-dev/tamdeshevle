...
assert.match(ui,/generated_operations:routed\.journey\?\.generatedOperations\|\|\[\]/,"assistant must preserve planner-operation provenance for deterministic verification");
