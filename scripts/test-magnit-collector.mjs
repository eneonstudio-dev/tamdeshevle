...
import { discoverMagnitProductUrls, pageImage, pagePack, pageUnitPrice, parseMagnitProductPage, rankMagnitProductUrls, verifyMagnitScopeConfig, withMagnitStore } from "../retailers/magnit-collector.mjs";
...
console.log("Magnit collector tests passed: store scoping, prioritization, product images, JSON-LD, explicit pack evidence, unit-price parsing and fallback parsing.");
