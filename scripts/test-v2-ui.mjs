...
new Function(ui);new Function(bai);
...
console.log("V2 UI contract passed: native Bay-first Votonobay shell, self-service fallback, full assistant entry, dark responsive styling, honest data labels and PWA identity are wired.");
